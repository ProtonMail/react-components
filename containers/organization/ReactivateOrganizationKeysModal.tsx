...
import { FormModal, LearnMore, Alert, Row, Label, Field, PasswordInput, PrimaryButton, Button } from '../../components';
        ...
        <FormModal
            ...
            submit={
                <div>
                    ...
                    <PrimaryButton loading={loading} onClick={() => withLoading(handleSubmit())}>{c('Action')
