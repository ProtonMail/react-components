...
const ViewModeRadios = () => {
    ...
    return (
        <>
            ...
            >
                <img alt="Group" src="design-system-website/assets/img/pm-images/conversation-group.svg" />
            </RadioCard>
            <RadioCard
                value={SINGLE}
            ...
            >
                <img alt="Single" src="design-system-website/assets/img/pm-images/conversation-single.svg" />
            </RadioCard>
        </>
    );
};
