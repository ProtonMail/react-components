...
const NewSubscriptionModalFooter = ({ submit, step, model, plans, onClose, method }) => {
    ...
    const upsells = [
        step === SUBSCRIPTION_STEPS.CUSTOMIZATION && model.cycle === CYCLE.MONTHLY && (
            <div key="upsell-1" className="nomobile flex flex-nowrap flex-align-items-center pl1 pr1">
                <PercentageIcon />
        ...
        step === SUBSCRIPTION_STEPS.CUSTOMIZATION && model.cycle === CYCLE.YEARLY && (
            <div key="upsell-2" className="nomobile flex flex-nowrap flex-align-items-center pl1 pr1">
                <TickIcon />
        ...
        step === SUBSCRIPTION_STEPS.CUSTOMIZATION && model.cycle === CYCLE.TWO_YEARS && (
            <div key="upsell-3" className="nomobile flex flex-nowrap flex-align-items-center pl1 pr1">
                <TickIcon />
        ...
        step === SUBSCRIPTION_STEPS.CUSTOMIZATION &&
            ...
            !isVisionary && (
                <div key="upsell-4" className="nomobile flex flex-nowrap flex-align-items-center pl1 pr1">
                    <PercentageIcon />
        ...
        step === SUBSCRIPTION_STEPS.CUSTOMIZATION &&
            ...
            model.coupon === COUPON_CODES.BUNDLE &&
            !isVisionary && (
                <div key="upsell-5" className="nomobile flex flex-nowrap flex-align-items-center pl1 pr1">
                    <TickIcon />
        ...
        step === SUBSCRIPTION_STEPS.PAYMENT && onlyVPN && (
            <div key="upsell-6" className="nomobile flex flex-nowrap flex-align-items-center pl1 pr1">
                <ClockIcon />
        ...
        step === SUBSCRIPTION_STEPS.PAYMENT && protectedPayment && (
            <div key="upsell-7" className="nomobile flex flex-nowrap flex-align-items-center pl1 pr1">
                <ShieldIcon />
                <span className="flex-item-fluid">
