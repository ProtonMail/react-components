                ...
                <thead>
                    <tr>
                        <th scope="col" className="aligncenter aligntop simple-table-row-th pt1">
                            <strong className="uppercase ellipsis inline-block max-w100" title="Free">
                                Free
                            </strong>
                            <div>
                        ...
                        <th scope="col" className="aligncenter aligntop simple-table-row-th pt1">
                            <strong className="uppercase ellipsis inline-block max-w100" title="Plus">
                                Plus
                            </strong>
                            <div>
                        ...
                        <th scope="col" className="aligncenter aligntop simple-table-row-th pt1">
                            <strong className="uppercase ellipsis inline-block max-w100" title="Professional">
                                Professional
                            </strong>
                            <div>
                                <SubscriptionPrices
                        ...
                        <th scope="col" className="aligncenter aligntop simple-table-row-th pt1">
                            <strong className="uppercase ellipsis inline-block max-w100" title="Visionary">
                                Visionary
                            </strong>
                            <div>
                                <SubscriptionPrices
