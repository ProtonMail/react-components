...
import { G_OAUTH_SCOPE_CONTACTS } from '../../constants';

import { Step, ImportContactsModalModel, IMPORT_ERROR } from '../interfaces';
...
const ImportContactsModal = ({ onClose = noop, oauthProps: initialOAuthProps, addresses, ...rest }: Props) => {
    ...
    const launchImport = async () => {
        ...
        await api(startContactsImportJob(importID, payload));
        await call();
