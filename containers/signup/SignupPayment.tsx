...
const SignupPayment = ({
    ...
    return (
        <form name="payment-form" onSubmit={onSubmit} method="post">
            ...
            <div className="flex-no-min-children flex-nowrap onmobile-flex-column onmobile-flex-wrap">
                <div className="flex-item-fluid no-min-dimensions onmobile-w100 pr1 onmobile-pr0">
                    <Payment
                        type="signup"
                        paypal={paypal}
