...
const DriveLogo = ({ className = 'logo' }: Props) => {
    ...
    if (FEATURE_FLAGS.includes('drive-rename')) {
        return (
            <svg
    ...
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
            viewBox="0 0 103.5 15.1"
            className={className}
            aria-labelledby="logo__title"
        >
            <g>
                <path d="M20.4 3.6h-3v11.2h1.9v-4h1.1c1.1.1 2.2-.2 3.1-.9.9-.6 1.4-1.7 1.3-2.7 0-2.3-1.5-3.6-4.4-3.6zm-1.1 1.6h1.1c1.6 0 2.4.6 2.4 2 .1.6-.2 1.2-.6 1.7-.6.2-1.2.4-1.8.3h-1.1v-4zM30.2 6c-.9 0-1.7.5-2.1 1.2L28 6.1h-1.6v8.6h1.9V9.9c.3-1.5.9-2.1 1.7-2.1.2 0 .4 0 .7.1l.2.1.3-1.8H31c-.3-.2-.6-.2-.8-.2zM35.5 6c-1.1 0-2.2.4-2.9 1.3-1.3 2-1.4 4.5 0 6.5 1.5 1.6 3.9 1.7 5.5.2.1-.1.2-.1.2-.2 1.3-2 1.3-4.5 0-6.5-.6-.9-1.7-1.4-2.8-1.3zm0 7.4c-1.3 0-1.9-1-1.9-2.9-.1-.8.1-1.6.5-2.3.3-.5.9-.7 1.4-.7s1.1.2 1.4.7c.4.7.6 1.5.5 2.2 0 2-.6 3-1.9 3zM45 13c-.3.2-.6.3-1 .3-.5 0-.8-.2-.8-1V7.7H45l.2-1.5h-2V4.1l-1.9.2v1.8H40v1.5h1.4v4.7c0 .7.2 1.4.6 1.9.5.5 1.1.7 1.8.7s1.4-.2 2-.6l.2-.1-.7-1.3-.3.1zM50.1 6c-1.1 0-2.2.4-2.9 1.3-1.3 2-1.3 4.5 0 6.5 1.5 1.6 3.9 1.7 5.5.2.1-.1.2-.1.2-.2 1.3-2 1.3-4.5 0-6.5-.6-.9-1.7-1.4-2.8-1.3zm0 7.4c-1.3 0-1.9-1-1.9-2.9-.1-.8.1-1.6.5-2.3.3-.5.9-.7 1.4-.7s1.1.2 1.4.7c.4.7.5 1.5.5 2.3 0 1.9-.6 2.9-1.9 2.9zM60 6c-.5 0-1.1.1-1.6.4-.3.2-.6.4-.8.6l-.1-.9h-1.6v8.6h1.9v-6c.6-.9 1.1-1.3 1.9-1.3.6 0 1.1.2 1.1 1.4v5.9h1.9v-6c0-.7-.2-1.4-.7-2-.6-.5-1.3-.8-2-.7zM75 4.6c-1.1-.8-2.5-1.1-3.8-1h-2.5v11.2h2.8c1.3.1 2.5-.3 3.5-1.1 1.2-1.2 1.9-2.8 1.7-4.5 0-1-.1-1.9-.5-2.8-.2-.7-.6-1.3-1.2-1.8zm-3.4 8.6h-1v-8h.9c.8-.1 1.6.2 2.2.6.8.9 1.2 2.1 1 3.3.1 3.7-1.7 4.1-3.1 4.1zM82.4 6c-.9 0-1.7.5-2.1 1.2l-.1-1.1h-1.6v8.6h1.9V9.9c.3-1.5.9-2.1 1.7-2.1.2 0 .4 0 .7.1l.2.1.3-1.8h-.2c-.2-.2-.5-.2-.8-.2zM85.6 2.2c-.7 0-1.2.5-1.2 1.2 0 .3.1.6.3.8.2.2.5.3.9.3.7 0 1.2-.5 1.2-1.2 0-.5-.5-1.1-1.2-1.1zM84.7 6.1h1.9v8.6h-1.9zM91.7 12.6l-2-6.4h-2l3 8.6h2l2.9-8.7h-2l-1.9 6.5zM102.3 7.1c-.3-.4-.7-.7-1.1-.9-.5-.2-1-.3-1.5-.3-1.1 0-2 .5-2.7 1.3-.7 1-1 2.1-1 3.3-.1 1.2.3 2.3 1 3.2.7.8 1.8 1.2 2.8 1.2 1.1 0 2.2-.4 3-1.1l.2-.1-.9-1.2-.2.1c-.6.4-1.3.7-2 .7-1.1 0-1.8-.7-2-2.2h5.2v-.2-.7c.2-1.1-.1-2.2-.8-3.1zM98 9.7c0-.6.2-1.1.5-1.6.3-.4.7-.6 1.2-.5.5 0 1 .2 1.3.6.3.5.5 1 .4 1.6L98 9.7z" />
            </g>
            <g>
                <path d="M9.6 4.5h-.1c-.7-1.8-2.8-2.8-4.6-2.1-1 .4-1.8 1.2-2.1 2.2C1.1 4.8-.1 6.2 0 7.8c.1 1.5 1.4 2.7 3 2.7h2.1V9.2H3.5l2.8-2.8 2.8 2.8H7.5v1.4H5.1V12H3.5l2.8 2.8L9.1 12H7.5v-1.4h2.2c1.7-.1 3-1.5 2.9-3.2-.1-1.6-1.4-2.9-3-2.9z" />
            </g>
