...
import { getSupportedEvents, parseIcs, splitErrors } from 'proton-shared/lib/helpers/import';
import { ImportFatalError } from 'proton-shared/lib/calendar/ImportFatalError';
import { FormModal, PrimaryButton, onlyDragFiles } from '../../index';
...
export const ImportModal = ({ calendars, defaultCalendar, ...rest }: Props) => {
    const api = useApi();
