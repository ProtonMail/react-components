...
// Implement the logic in the Confluence 'Send preferences for outgoing email': https://confluence.protontech.ch/display/MAILFE/Send+preferences+for+outgoing+email
/**
